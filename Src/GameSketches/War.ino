...
This is a game where a player navigates the screens rows and shoots at enemies that spawn in random locations.

This game is unfinished!
In the future the enemies should shoot back and more than one enemy should spawn. THe game should end when the player is shot and the goal is to get a high scpre before dying.
